const CACHE='oliveira-frota-v7-offline-first';
const ASSETS=['./','./index.html','./styles.css','./app.js','./cloud-sync.js','./manifest.webmanifest','./assets/logo-oliveira.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/favicon.png'];
